...
ALTER TABLE host_profiles
  ...
  ADD COLUMN IF NOT EXISTS commission_rate DECIMAL(5,2) NOT NULL DEFAULT 15.00 AFTER bank_account_type,
  ADD COLUMN IF NOT EXISTS approval_status ENUM('pending_approval', 'approved', 'rejected') NOT NULL DEFAULT 'pending_approval' AFTER commission_rate,
